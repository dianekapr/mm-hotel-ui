...
export default function PackageCard({ pkg, currentCard, totalCards, onCardChangeAction }: { pkg: packageType, currentCard: number, totalCards: number, onCardChangeAction: (newIndex: number) => void }) {
